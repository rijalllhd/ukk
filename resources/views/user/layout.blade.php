...
<html lang="en">
  ...
  <body >
          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="{{route('logout.user')}}" class="dropdown-item">Logout</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item {{ Request::routeIs('buku.user') ? 'active' : '' }}">
                  <a class="nav-link" href="{{route('buku.user')}}" >
                    <span class="nav-link-title">
                      Seluruh Buku
                    </span>
                  </a>
    ...
    <!-- Libs JS -->
    <script src="{{asset('asset/user/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062')}}" defer></script>
    <script src="{{asset('asset/user/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062')}}" defer></script>
    <script src="{{asset('asset/user/dist/libs/jsvectormap/dist/maps/world.js?1684106062')}}" defer></script>
    <script src="{{asset('asset/user/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062')}}" defer></script>
    <!-- Tabler Core -->
