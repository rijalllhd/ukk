...
@section('content')
    <div class="col-12">
        <div class="card">
            ...
            <h3 class="card-title">Seluruh Buku</h3>
            </div>
            ...
            <div class="table-responsive">
                <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <!-- <td>
                            <img src="{{ asset( $buku->cover) }}" alt="img" style="width:140px; height: 210px; object-fit: cover;">
                        </td> -->
                        <td>
                            {{$buku->judul}}
                        </td>
                        ...
                        <td>
                            <a href="" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#info{{$buku->id}}">
    ...
    <!-- info modal -->
    @foreach($bukus as $buku)
    <div class="modal modal-blur fade" id="info{{$buku->id}}" tabindex="-1" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Info buku {{$buku->judul}}</h5>
