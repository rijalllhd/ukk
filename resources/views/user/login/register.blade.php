  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{route('register.proses.user')}}" method="post" autocomplete="off" novalidate>
            @csrf
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="texxt" name="alamat" class="form-control" placeholder="alamat">
            </div>
        ...
        <div class="text-center text-muted mt-3">
          Already have account? <a href="{{route('formlogin_user')}}" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
