...
<head>
  ...
  <link rel="stylesheet" href="{{asset('/asset/admin/compiled/css/iconly.css')}}">
</head>
...
<body>
                ...
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                            by <a href="https://saugi.me">Rizal Hadi</a></p>
                    </div>
                </div>
            </footer>
    ...
    <!-- Choices for multiple select -->
    <script src="{{asset('/asset/admin/extensions/choices.js/public/assets/scripts/choices.js')}}"></script>
    <script src="{{asset('/asset/admin/static/js/pages/form-element-select.js')}}"></script>

    <!-- Need: Apexcharts -->
    <script src="{{asset('/asset/admin/extensions/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('/asset/admin/static/js/pages/dashboard.js')}}"></script>
